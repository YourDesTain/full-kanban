      ...
      <div className={styles.container}>
        <div className={styles.name}>
          ...
          <Typography.Title
            ...
            editable={{
              ...
              icon: <EditOutlined className={styles.titleEditIcon} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />,
            }}
          >
            {name}
          </Typography.Title>
        ...
        >
          ...
          <SingleElementForm
            ...
            icon={<GlobalOutlined className="tertiary" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
        ...
        <Card
          title={
            <Space size={15}>
              <SafetyCertificateOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
