    ...
    <div className={styles.container}>
      ...
      >
        <Input
          ...
          prefix={
            <SearchOutlined
              className={cn(styles.inputPrefix, "secondary", "tertiary")} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}            />
          }
...
type Hit = (User | Task | Quote | Event) & {
  resource: string;
};
                ...
                avatar={
                  "avatarUrl" in item ? (
                    <CustomAvatar
                      src={item.avatarUrl}
                      shape={
                        item.resource === "companies" ? "square" : "circle"
                      }
                    >
                      {item.name}
                    </CustomAvatar>
